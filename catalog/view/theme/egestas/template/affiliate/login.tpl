...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="login-content clearafter">
    <div class="left">
      ...
      <div class="buttons">
        <div class="right">
        <a href="<?php echo $register; ?>" class="icon-foward-white button"><?php echo $button_continue; ?></a>
        </div>
      </div>
    </div>
    <div class="right">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        <div class="content">
		  ...
		  <div class="right">
          <input type="submit" value="<?php echo $button_login; ?>" class="icon-lock-white button" />
		  </div>
          <?php if ($redirect) { ?>
