...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="center">
      <a href="<?php echo $continue; ?>" class="icon-foward-white button"><?php echo $button_shopping; ?></a>&nbsp;&nbsp;
      <a href="<?php echo $checkout; ?>" class="icon-checkout-white button"><?php echo $button_checkout; ?></a>
	</div>
  </div>
  </div>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '  <div class="buttons" align="center"><input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="icon-foward-white button" /></div>';	
				<?php } else { ?>
				html += '  <div class="buttons" align="center"><input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="icon-foward-white button" disabled="disabled" /></div>';	
				<?php } ?>
